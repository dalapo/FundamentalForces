        ...
        return Commands.literal("checkarea")
                ...
                .executes((context) -> {
                    ...
                    if (source.getEntity() instanceof ServerPlayer player) {
                        ...
                        boolean heightmap = StarfallSafetyManager.chunkChangesCheck(level, player.blockPosition(), 1);
                        boolean blocks = StarfallSafetyManager.stateTagCheck(level, StarfallSafetyManager.nearbyBlockList(level, player.blockPosition()));
